...
public class Namangan {
    ...
    public SendMessage sendTextMessage(Message message){
        ...
        keyboardRow1.add("Namangan shahri");
        keyboardRow1.add("Mingbuloq tumani");
        keyboardRow1.add("Chortoq tumani");
        keyboardRow2.add("Uchqorg'on tumani");
        keyboardRow2.add("Chust tumani");
        keyboardRow2.add("Pop tumani");
        keyboardRow3.add("Uychi tumani");
