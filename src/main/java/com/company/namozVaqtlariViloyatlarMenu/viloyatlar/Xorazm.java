...
public class Xorazm {
    ...
    public SendMessage sendTextMessage(Message message){
        ...
        keyboardRow1.add("Urganch shahri");
        keyboardRow1.add("Yangibozor tumani");
        keyboardRow1.add("Xazorast tumani");
        keyboardRow2.add("Xonqa tumani");
        keyboardRow2.add("Xiva shahri");
