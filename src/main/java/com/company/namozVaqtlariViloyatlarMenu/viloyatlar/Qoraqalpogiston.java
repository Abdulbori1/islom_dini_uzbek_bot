...
public class Qoraqalpogiston {
    ...
    public SendMessage sendTextMessage(Message message){
        ...
        keyboardRow1.add("Nukus shahri");
        keyboardRow1.add("To'rtkol tumani");
        keyboardRow2.add("Mo'ynoq tumani");
        keyboardRow2.add("Qo'ng'irot tumani");
        keyboardRow1.add("Taxtakopik tumani");
