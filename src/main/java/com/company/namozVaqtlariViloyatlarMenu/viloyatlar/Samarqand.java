...
public class Samarqand {
    ...
    public SendMessage sendTextMessage(Message message){
        ...
        keyboardRow1.add("Samarqand shahri");
        keyboardRow1.add("Kattaqorg'on tumani");
        keyboardRow2.add("Ishtixon tumani");
        keyboardRow2.add("Urgut tumani");
        keyboardRow1.add("Mirbozor tumani");
