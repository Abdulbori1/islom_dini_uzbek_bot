...
public class Fargona {
    ...
    public SendMessage sendTextMessage(Message message){
        ...
        keyboardRow1.add("Farg'ona shahri");
        keyboardRow1.add("Marg'ilon tumani");
        keyboardRow1.add("Oltiariq tumani");
        keyboardRow2.add("Quva tumani");
        keyboardRow2.add("Qoqon shahri");
        keyboardRow3.add("Bag'dod tumani");
