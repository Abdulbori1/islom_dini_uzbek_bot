...
public class Surxondaryo {
    ...
    public SendMessage sendTextMessage(Message message){
        ...
        keyboardRow1.add("Termiz shahri");
        keyboardRow1.add("Sherobod tumani");
        keyboardRow2.add("Boysun tumani");
        keyboardRow2.add("Sho'rchi tumani");
        keyboardRow1.add("Denov tumani");
