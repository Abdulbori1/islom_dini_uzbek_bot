...
public class Masad {
    ...
    public SendMessage sendTextMessage(Message message){
        ...
        sendMessage1.setText("Таббат Йадааа Абии Ляхабиe-Уа Таббэ.\n" +
                "Мааа Агнаа Анху Маалюхуу Уа Маа Касабэ.\n" +
                "Сайасляя Наараан Заата Ляхабэ.\n" +
                "Уамра атухуу Хаммаляталь-Хатабэ.\n" +
                "Фии Джиидиха Хаблюм-Мимм-Масад.");
    ...
    public SendAudio sendAudioMessage(Message message){
        ...
        sendAudio.setCaption("Mishary Rashid - Masad surasi");
        return sendAudio;
    }
}
